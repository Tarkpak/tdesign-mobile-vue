...
prefixIcon | Function / Slot / Function | - | Typescript：`function \| TNode`。[see more ts definition](https://github.com/Tencent/tdesign-mobile-vue/blob/develop/src/common.ts) | N
